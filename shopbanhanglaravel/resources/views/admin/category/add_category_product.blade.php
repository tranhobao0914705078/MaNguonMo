                        ...
                        ?>
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="8" required class="form-control" name="category_product_keywords" id="cate_ckeditor" placeholder="Nhập Mô Tả Danh Mục..."></textarea>
                                </div>
                                <div class="form-group">
