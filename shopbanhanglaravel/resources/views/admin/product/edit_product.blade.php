                        ...
                        ?>
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{URL::to('public/uploads/product/'.$pro->product_image)}}" height="100" width="100" alt="img">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    id="exampleInputEmail1" placeholder="Tags Sản Phẩm..." value="{{$pro->product_tags}}">
                                </div>
                                <div class="form-group">
