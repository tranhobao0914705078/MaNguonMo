    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="public/backend/images/user.jpg">
                <span class="username">
				<?php
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/manage-slider')}}">Danh Sách Banner</a></li>
                    </ul>
                </li>
				<li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/information')}}">Thông Tin Web</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/all-role')}}">Danh Sách Quyền</a></li>
                    </ul>
                </li>
				@endhasrole
				<li class="sub-menu">
...
<script  type="text/javascript">
	$('.update_quantity_order').click(function(){
		...
		if(parseInt(order_qty) == 0){
			alert('Số Lượng Của Đơn Hàng Phải Lớn Hơn 0');
			location.reload();
		}else{
			$.ajax({
				url: "{{url('/update-qty')}}",
...
<script>
	...
	CKEDITOR.replace('pro_edit_ckeditor');
	CKEDITOR.replace('pro_edit_ckeditor1');
	//category
	CKEDITOR.replace('cate_ckeditor');
	CKEDITOR.replace('cate_edit_ckeditor');
	//brand
	CKEDITOR.replace('brand_ckeditor');
	CKEDITOR.replace('brand_edit_ckeditor');
	//slider
	CKEDITOR.replace('slider_ckeditor');
	//contact
	CKEDITOR.replace('contact_ckeditor1');
	CKEDITOR.replace('contact_ckeditor2');
	CKEDITOR.replace('contact_ckeditor3');
</script>
...
<script type="text/javascript">
	$('.order_details').change(function(){
		...
		for(i = 0; i < order_product_id.length; i++){
			...
			var order_qty_store = $('.order_qty_store_' + order_product_id[i]).val();
			
			if(parseInt(order_qty) > parseInt(order_qty_store)){
				j = j + 1;
				if(j == 1){
